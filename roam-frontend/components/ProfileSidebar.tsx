...
const Sidebar: React.FC = () => {
  return (
    ...
    <div className="flex flex-col gap-6 flex-grow">
      <a href="#" className="gap-2.5 self-stretch px-2 py-2.5 whitespace-nowrap bg-white rounded-lg min-h-[33px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
        Home
      </a>
      <a href="#" className="gap-2.5 self-stretch px-2 py-2.5 whitespace-nowrap bg-white rounded-lg min-h-[33px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
        Purchases
    ...
    <div className="absolute bottom-0 w-[8.5%]">
