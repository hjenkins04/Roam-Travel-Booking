...
describe('Header Component', () => {
  ...
  beforeEach(() => {
    ...
    jest.clearAllMocks();
    (useAuth as jest.Mock).mockReturnValue({ isSignedIn: false, signOut: mockSignOut });
  ...
  test('does not show Login and Sign Up buttons when the user is signed in', () => {
    ...
    (useAuth as jest.Mock).mockReturnValue({ isSignedIn: true, signOut: mockSignOut });
  ...
  test('Renders correct header sizes and background images', async () => {
    ...
    const tallHeaderBackground = await waitFor(() => screen.queryByTestId('tall-header-background'));
    ...
    await waitFor(() => {
      const smallTallBackground = screen.queryByTestId('tall-header-background');
