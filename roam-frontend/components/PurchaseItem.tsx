...
const PurchaseItem: React.FC<PurchaseItemProps> = ({ title, outboundFlight, returnFlight }) => {
  return (
...
const FlightDetails: React.FC<FlightDetailsProps> = ({
  ...
  return (
    <div className={`flex flex-col ${isReturn ? 'ml-5 w-[45%]' : 'w-[55%]'} max-md:ml-0 max-md:w-full`}>
      <div className="flex flex-col grow max-md:max-w-full">
        <div className="flex flex-col items-start pr-14 pl-6 mt-7 w-full max-md:px-5 max-md:max-w-full">
          ...
          <div className="flex gap-2 items-start self-stretch mt-2 max-md:ml-2">
            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/47154ef659dd968075223e67363fb44c6d051fe030370f4062cd21cc5bd1ef89?placeholderIfAbsent=true&apiKey=7a7173da98bb425ca4236bb2160d9309" className="object-contain shrink-0 w-10 aspect-square" alt="" />
            ...
            <div className="flex flex-col text-base text-right min-h-[74px] text-slate-800">
              <p>{duration}</p>
              <p className="mt-1">{departureTime} - {arrivalTime}</p>
